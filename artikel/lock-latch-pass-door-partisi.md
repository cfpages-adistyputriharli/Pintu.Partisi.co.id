---
article_id: PDP-03-05
title: "Locks, Latches, dan Pass-Door Hardware"
slug: "lock-latch-pass-door-partisi"
description: "Cover operation, keys, accessibility, egress, seals, and inspection"
status: outline
publication_date: "2025-11-02"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: PDP-03
primary_intent: "Specify closing hardware"
reader_community: "Partisi.co.id"
reader_address: "Kawan Partisi.co.id"
final_route: "/artikel/lock-latch-pass-door-partisi.html"
...
# Locks, Latches, dan Pass-Door Hardware

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Locks, Latches, dan Pass-Door Hardware”
- **Reader and situation:** Facility/designer
- **Reader outcome:** Cover operation, keys, accessibility, egress, seals, and inspection
- **Primary intent:** Specify closing hardware
...
- **Scope boundary:** Excludes code compliance PDP-06-03
- **Final public route:** `/artikel/lock-latch-pass-door-partisi.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Locks, Latches, dan Pass-Door Hardware**.
...
- **Tie back to this article:** Keep the explanation specific to “Locks, Latches, dan Pass-Door Hardware”.
