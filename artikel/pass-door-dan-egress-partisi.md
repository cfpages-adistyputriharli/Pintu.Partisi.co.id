---
article_id: PDP-06-03
title: "Pass Door, Egress, dan Emergency Use"
slug: "pass-door-dan-egress-partisi"
description: "Cover route continuity, hardware, opening, threshold, locking, signage, power loss, and approval"
status: outline
publication_date: "2026-01-07"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: PDP-06
primary_intent: "Coordinate evacuation needs"
reader_community: "Partisi.co.id"
reader_address: "Teman Partisi.co.id"
final_route: "/artikel/pass-door-dan-egress-partisi.html"
...
# Pass Door, Egress, dan Emergency Use

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Pass Door, Egress, dan Emergency Use”
- **Reader and situation:** Architect/facility owner
- **Reader outcome:** Cover route continuity, hardware, opening, threshold, locking, signage, power loss, and approval
- **Primary intent:** Coordinate evacuation needs
...
- **Scope boundary:** Excludes code certification
- **Final public route:** `/artikel/pass-door-dan-egress-partisi.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Pass Door, Egress, dan Emergency Use**.
...
- `PDP-06-01` → `/artikel/aksesibilitas-pintu-partisi.html` — Aksesibilitas Pintu Partisi: User Journey dan Hambatan
- `PDP-06-02` → `/artikel/bahaya-mekanis-pintu-partisi.html` — Pinch, Crush, Tip, dan Impact Hazards
- `PDP-06-04` → `/artikel/keselamatan-partisi-area-publik.html` — Pintu Partisi untuk Anak dan Area Publik
...
- **Tie back to this article:** Keep the explanation specific to “Pass Door, Egress, dan Emergency Use”.
