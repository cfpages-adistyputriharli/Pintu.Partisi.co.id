---
article_id: PDP-12-04
title: "Panel Berat, Macet, Berisik, atau Tidak Rapat"
slug: "troubleshooting-pintu-partisi"
description: "Map symptoms to track/roller/alignment/seal/hardware causes, evidence, isolation, and escalation"
status: outline
publication_date: "2026-06-02"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: PDP-12
primary_intent: "Triage common symptoms"
reader_community: "Partisi.co.id"
reader_address: "Sobat Partisi.co.id"
final_route: "/artikel/troubleshooting-pintu-partisi.html"
...
# Panel Berat, Macet, Berisik, atau Tidak Rapat

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Panel Berat, Macet, Berisik, atau Tidak Rapat”
- **Reader and situation:** Operator/maintainer
- **Reader outcome:** Map symptoms to track/roller/alignment/seal/hardware causes, evidence, isolation, and escalation
- **Primary intent:** Triage common symptoms
...
- **Scope boundary:** Excludes suspended-system repair
- **Final public route:** `/artikel/troubleshooting-pintu-partisi.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Panel Berat, Macet, Berisik, atau Tidak Rapat**.
...
- `PDP-12-02` → `/artikel/sop-stacking-panel-partisi.html` — SOP Stacking dan Unstacking Panel
- `PDP-12-03` → `/artikel/perawatan-seal-dan-finishing-partisi.html` — Cleaning dan Perawatan Seal/Finish
- `PDP-12-05` → `/artikel/maintenance-pintu-partisi.html` — Maintenance Schedule Berbasis Penggunaan
- `PDP-12-06` → `/artikel/troubleshooting-partisi-otomatis.html` — Troubleshooting Partisi Otomatis
...
- **Tie back to this article:** Keep the explanation specific to “Panel Berat, Macet, Berisik, atau Tidak Rapat”.
