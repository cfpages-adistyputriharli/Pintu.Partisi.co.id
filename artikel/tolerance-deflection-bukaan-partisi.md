---
article_id: PDP-05-02
title: "Tolerance, Deflection, dan Movement pada Bukaan"
slug: "tolerance-deflection-bukaan-partisi"
description: "Explain level/plumb, overhead deflection, joints, seals, finishes, and monitoring"
status: outline
publication_date: "2025-12-11"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: PDP-05
primary_intent: "Coordinate movement allowance"
reader_community: "Partisi.co.id"
reader_address: "Sobat Partisi.co.id"
final_route: "/artikel/tolerance-deflection-bukaan-partisi.html"
...
# Tolerance, Deflection, dan Movement pada Bukaan

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Tolerance, Deflection, dan Movement pada Bukaan”
- **Reader and situation:** Designer
- **Reader outcome:** Explain level/plumb, overhead deflection, joints, seals, finishes, and monitoring
- **Primary intent:** Coordinate movement allowance
...
- **Scope boundary:** Excludes numerical design limits
- **Final public route:** `/artikel/tolerance-deflection-bukaan-partisi.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Tolerance, Deflection, dan Movement pada Bukaan**.
...
- `PDP-05-01` → `/artikel/survei-bukaan-pintu-partisi.html` — Checklist Survei Bukaan Pintu Partisi
...
- **Tie back to this article:** Keep the explanation specific to “Tolerance, Deflection, dan Movement pada Bukaan”.
