---
article_id: PDP-06-04
title: "Pintu Partisi untuk Anak dan Area Publik"
slug: "keselamatan-partisi-area-publik"
description: "Cover supervision, misuse, climb/impact, fingers, locks, storage, inspection, and training"
status: outline
publication_date: "2026-01-10"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: PDP-06
primary_intent: "Define vulnerable-user controls"
reader_community: "Partisi.co.id"
reader_address: "Teman Partisi.co.id"
final_route: "/artikel/keselamatan-partisi-area-publik.html"
...
# Pintu Partisi untuk Anak dan Area Publik

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Pintu Partisi untuk Anak dan Area Publik”
- **Reader and situation:** School/public venue
- **Reader outcome:** Cover supervision, misuse, climb/impact, fingers, locks, storage, inspection, and training
- **Primary intent:** Define vulnerable-user controls
...
- **Scope boundary:** Excludes universal child-safe claim
- **Final public route:** `/artikel/keselamatan-partisi-area-publik.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Pintu Partisi untuk Anak dan Area Publik**.
...
- `PDP-06-02` → `/artikel/bahaya-mekanis-pintu-partisi.html` — Pinch, Crush, Tip, dan Impact Hazards
- `PDP-06-03` → `/artikel/pass-door-dan-egress-partisi.html` — Pass Door, Egress, dan Emergency Use
- `PDP-06-05` → `/artikel/keselamatan-partisi-otomatis.html` — Safety pada Partisi Otomatis
- `PDP-06-06` → `/artikel/stop-condition-pintu-partisi.html` — Stop Condition saat Panel Tidak Stabil atau Macet
...
- **Tie back to this article:** Keep the explanation specific to “Pintu Partisi untuk Anak dan Area Publik”.
