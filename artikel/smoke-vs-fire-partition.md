---
article_id: PDP-08-03
title: "Smoke Control vs Fire Resistance pada Partisi"
slug: "smoke-vs-fire-partition"
description: "Separate smoke leakage/control concepts from fire resistance and egress strategy"
status: outline
publication_date: "2026-02-19"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: PDP-08
primary_intent: "Distinguish claims"
reader_community: "Partisi.co.id"
reader_address: "Teman Partisi.co.id"
final_route: "/artikel/smoke-vs-fire-partition.html"
...
# Smoke Control vs Fire Resistance pada Partisi

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Smoke Control vs Fire Resistance pada Partisi”
- **Reader and situation:** Designer reviewing submittals
- **Reader outcome:** Separate smoke leakage/control concepts from fire resistance and egress strategy
- **Primary intent:** Distinguish claims
...
- **Scope boundary:** Excludes code design
- **Final public route:** `/artikel/smoke-vs-fire-partition.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Smoke Control vs Fire Resistance pada Partisi**.
...
- `PDP-08-01` → `/artikel/bukti-fire-rated-operable-wall.html` — Fire-Rated Operable Wall: Bukti Complete Assembly
- `PDP-08-02` → `/artikel/komponen-vs-assembly-tahan-api.html` — Komponen Tahan Api Tidak Otomatis Membuat Sistem Rated
- `PDP-08-04` → `/artikel/interface-fire-rated-partition.html` — Penetration dan Interface pada Fire-Rated Partition
- `PDP-08-05` → `/artikel/inspeksi-fire-rated-operable-wall.html` — Inspeksi dan Maintenance Sistem Fire-Rated
...
- **Tie back to this article:** Keep the explanation specific to “Smoke Control vs Fire Resistance pada Partisi”.
