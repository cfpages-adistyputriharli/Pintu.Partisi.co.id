---
article_id: PDP-11-03
title: "Alignment Track dan Panel"
slug: "alignment-track-dan-panel-partisi"
description: "Cover datum, straightness/level, joints, floor relationship, stack, operation, records, and disposition"
status: outline
publication_date: "2026-05-02"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: PDP-11
primary_intent: "Verify movement geometry"
reader_community: "Partisi.co.id"
reader_address: "Teman Partisi.co.id"
final_route: "/artikel/alignment-track-dan-panel-partisi.html"
...
# Alignment Track dan Panel

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Alignment Track dan Panel”
- **Reader and situation:** Installer/QC
- **Reader outcome:** Cover datum, straightness/level, joints, floor relationship, stack, operation, records, and disposition
- **Primary intent:** Verify movement geometry
...
- **Scope boundary:** Excludes invented tolerances
- **Final public route:** `/artikel/alignment-track-dan-panel-partisi.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Alignment Track dan Panel**.
...
- `PDP-11-01` → `/artikel/tahapan-instalasi-pintu-partisi.html` — Tahapan Instalasi Pintu Partisi
- `PDP-11-02` → `/artikel/readiness-check-track-partisi.html` — Readiness Check sebelum Track Dipasang
- `PDP-11-04` → `/artikel/setting-seal-pintu-partisi.html` — Setting Seal dan Final Closure
- `PDP-11-05` → `/artikel/functional-test-pintu-partisi.html` — Functional Test dan Commissioning
...
- **Tie back to this article:** Keep the explanation specific to “Alignment Track dan Panel”.
