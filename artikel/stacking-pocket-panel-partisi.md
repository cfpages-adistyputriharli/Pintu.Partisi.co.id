---
article_id: PDP-03-03
title: "Stacking Pocket dan Panel Parking"
slug: "stacking-pocket-panel-partisi"
description: "Define stack geometry, access, doors, MEP conflicts, protection, and retrieval"
status: outline
publication_date: "2025-10-25"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: PDP-03
primary_intent: "Plan panel storage"
reader_community: "Partisi.co.id"
reader_address: "Teman Partisi.co.id"
final_route: "/artikel/stacking-pocket-panel-partisi.html"
...
# Stacking Pocket dan Panel Parking

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Stacking Pocket dan Panel Parking”
- **Reader and situation:** Architect
- **Reader outcome:** Define stack geometry, access, doors, MEP conflicts, protection, and retrieval
- **Primary intent:** Plan panel storage
...
- **Scope boundary:** Excludes room selection PDP-04-01
- **Final public route:** `/artikel/stacking-pocket-panel-partisi.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Stacking Pocket dan Panel Parking**.
...
- `PDP-03-01` → `/artikel/track-roller-carrier-partisi.html` — Track, Roller, dan Carrier Pintu Partisi
- `PDP-03-02` → `/artikel/konfigurasi-track-partisi.html` — Straight, Curved, dan Multi-Direction Track
- `PDP-03-04` → `/artikel/hardware-sambungan-panel-partisi.html` — Hinges, Pivots, dan Connectors
...
- **Tie back to this article:** Keep the explanation specific to “Stacking Pocket dan Panel Parking”.
