---
article_id: PDP-08-04
title: "Penetration dan Interface pada Fire-Rated Partition"
slug: "interface-fire-rated-partition"
description: "Cover supports, ceilings/walls, joints, pass doors, power, penetrations, labels, and responsibility"
status: outline
publication_date: "2026-02-24"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: PDP-08
primary_intent: "Coordinate assembly boundaries"
reader_community: "Partisi.co.id"
reader_address: "Teman Partisi.co.id"
final_route: "/artikel/interface-fire-rated-partition.html"
...
# Penetration dan Interface pada Fire-Rated Partition

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Penetration dan Interface pada Fire-Rated Partition”
- **Reader and situation:** MEP/architect team
- **Reader outcome:** Cover supports, ceilings/walls, joints, pass doors, power, penetrations, labels, and responsibility
- **Primary intent:** Coordinate assembly boundaries
...
- **Scope boundary:** Excludes firestopping design
- **Final public route:** `/artikel/interface-fire-rated-partition.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Penetration dan Interface pada Fire-Rated Partition**.
...
- `PDP-08-03` → `/artikel/smoke-vs-fire-partition.html` — Smoke Control vs Fire Resistance pada Partisi
- `PDP-08-05` → `/artikel/inspeksi-fire-rated-operable-wall.html` — Inspeksi dan Maintenance Sistem Fire-Rated
- `PDP-08-06` → `/artikel/repair-fire-rated-operable-wall.html` — Retrofit atau Repair Assembly Tahan Api
...
- **Tie back to this article:** Keep the explanation specific to “Penetration dan Interface pada Fire-Rated Partition”.
